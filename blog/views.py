...
from .forms import EmialPostForm, CommentForm, SearchForm
...
def post_detail(request, year, month, day, post):
    ...
    # List of active comments for the this post
...
def post_comment(request, post_id):
    ...
    if form.is_valid():
        # Create c comment object without saving it to the database
